...
def predict_live_flood(locality: str) -> dict:
    ...
    location = {"latitude": weather["latitude"], "longitude": weather["longitude"], "elevation_m_approx": weather["elevation_m_approx"]}
    ...
    return {
        ...
        "current": {"rainfall_input_mm": current_features["rainfall_mm"], "probability": current_result["probability"], "risk_band": current_result["risk_band"]},
        "next_24h": {"forecast_rainfall_mm": forecast_features["rainfall_mm"], "probability": forecast_result["probability"], "risk_band": forecast_result["risk_band"]},
